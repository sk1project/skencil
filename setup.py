...
Copyright (C) 2010 by Igor E. Novikov. sK1 Team (http://sk1project.org) 
        ...
        classifiers=[
            ...
            'skencil.Sketch': 'src/skencil/Sketch',
            'skencil.Sketch.Modules': 'src/skencil/Sketch/Modules',
            },
...
if COPY:
    ...
    shutil.copy('build/lib.linux-' + platform.machine() + '-' + version + '/skencil/Sketch/Modules/paxmodule.so', 'src/skencil/Sketch/Modules/')
    print '\n paxmodule.so has been copied to src/ directory'

    shutil.copy('build/lib.linux-' + platform.machine() + '-' + version + '/skencil/Sketch/Modules/paxtkinter.so', 'src/skencil/Sketch/Modules/')
    print '\n paxtkinter.so has been copied to src/ directory'

    shutil.copy('build/lib.linux-' + platform.machine() + '-' + version + '/skencil/Sketch/Modules/intl.so', 'src/skencil/Sketch/Modules/')
    print '\n intl.so has been copied to src/ directory'

    shutil.copy('build/lib.linux-' + platform.machine() + '-' + version + '/skencil/Sketch/Modules/pstokenize.so', 'src/skencil/Sketch/Modules/')
    print '\n pstokenize.so has been copied to src/ directory'

    shutil.copy('build/lib.linux-' + platform.machine() + '-' + version + '/skencil/Sketch/Modules/_sketchmodule.so', 'src/skencil/Sketch/Modules/')
    print '\n _sketchmodule.so has been copied to src/ directory'

    shutil.copy('build/lib.linux-' + platform.machine() + '-' + version + '/skencil/Sketch/Modules/skreadmodule.so', 'src/skencil/Sketch/Modules/')
    print '\n skreadmodule.so has been copied to src/ directory'

    shutil.copy('build/lib.linux-' + platform.machine() + '-' + version + '/skencil/Sketch/Modules/streamfilter.so', 'src/skencil/Sketch/Modules/')
    print '\n streamfilter.so has been copied to src/ directory'

    shutil.copy('build/lib.linux-' + platform.machine() + '-' + version + '/skencil/Sketch/Modules/_type1module.so', 'src/skencil/Sketch/Modules/')
